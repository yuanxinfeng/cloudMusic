    ...
    <div class="playlists">
        <div class="top-container">
            ...
            <div class="top-right">
                ...
                <div class="creator">
                    <img :src="detail.dj.avatarUrl" alt @click.stop="clickUser(detail.userId)" />
                ...
                <div class="btn">
                    ...
                    <div class="sc">
                        ...
                        <span>订阅({{detail.subscribedCount | conversionCounts}})</span>
                    </div>
                    <div class="share">
                ...
                <div class="other">
                    ...
                    <div class="desc">
                        ...
                        <i
                            :class="['iconfont', descflag?'icon-xia-desc':'icon-shang-desc']"
                            @click="descClick"
                        ></i>
                    </div>
                </div>
        ...
        <div class="bottom-container">
            <ul>
                <li>
                    <span
                        @click="changeClick('songTable')"
                        :class="[active==='songTable'?'current':'']"
                    >歌曲列表</span>
                </li>
                <li>
                    <span
                ...
                <li>
                    <span
                        @click="changeClick('collectors')"
                        :class="[active==='collectors'?'current':'']"
                    >收藏者</span>
                </li>
