 ...
 * @Date: 2020-03-23 16:35:43
 * @LastEditors: Jasper
 * @LastEditTime: 2020-03-24 10:09:04
 -->
<template>
    <div class="payGiftLists">
        <ul>
            <li
                v-for="(item,index) in payGiftList"
                :key="index"
                @click.stop="clickPayGift(item.id)"
                    ...
                    <div class="title">
                        ...
                        <p class="originalPrice">
                            ...
                            <span
                                ...
                                class="discountPrice"
                            >/黑胶VIP:￥{{item.discountPrice/100}}</span>
                        </p>
                    </div>
                </div>
            </li>
